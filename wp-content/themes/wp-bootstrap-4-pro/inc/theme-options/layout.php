...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( 'Transparent Header on Static Frontpage', 'wp-bootstrap-4' ),
	'section'  => 'wp_bp_layout',
	'type'     => 'checkbox',
    'default'  => 1,
) );
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( 'Full Width Page Title with Background', 'wp-bootstrap-4' ),
	'section'  => 'wp_bp_layout',
	'type'     => 'checkbox',
    'default'  => 1,
    'tooltip'  => esc_html__( 'This setting is not for static frontpage.', 'wp-bootstrap-4' ),
) );
